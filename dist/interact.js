...
var autoScroll = {
  ...
  start: function start(interaction) {
    ...
    if ((typeof window === 'undefined' ? 'undefined' : _typeof(window)) !== undefined && window.parentIFrame) {
      //iFrameResizer
  ...
  scroll: function scroll() {
    ...
    if (s >= 1) {
      if (autoScroll.parentIframePageInfo && autoScroll.parentIframePageInfo.innerHeight) {
        //iFrameResizer
        ...
        if (autoScroll.x != 0 || autoScroll.y != 0) {
          window.parentIFrame.scrollTo(autoScroll.parentIframePageInfo.scrollLeft, autoScroll.parentIframePageInfo.scrollTop);
        }
      }
  ...
  onInteractionMove: function onInteractionMove(_ref) {
    ...
    if (autoScroll.parentIframePageInfo && autoScroll.parentIframePageInfo.innerHeight) {
      ...
      var screenX = pointer.clientX - autoScroll.parentIframePageInfo.scrollLeft + autoScroll.parentIframePageInfo.offsetLeft;
      var screenY = pointer.clientY - autoScroll.parentIframePageInfo.scrollTop + autoScroll.parentIframePageInfo.offsetTop;
